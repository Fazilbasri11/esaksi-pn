...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
            ...
            <div class="max-w-lg text-[1.2rem] text-center">
                <p>
                    Selamat datang di Aplikasi E-Saksi, sebuah sistem penjadwalan sidang terintegrasi yang dirancang untuk mempermudah proses administrasi persidangan. Dengan fitur yang canggih dan terstruktur, kami memastikan setiap tahapan persidangan berjalan lebih efisien, transparan, dan akurat.
                </p>
            </div>

            <div class="max-w-lg text-[1.2rem] text-center">
                Silahkan Pilih Agenda Untuk Menlanjutkan
            </div>
